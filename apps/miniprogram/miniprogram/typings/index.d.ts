...
interface IAppOption {
  ...
  loginWithPhone(email: string, nickname?: string): Promise<{ success: boolean; isNewUser?: boolean; error?: string }>
  loginWithEmailCode(email: string, code: string, nickname?: string): Promise<{ success: boolean; isNewUser?: boolean; error?: string }>
